# Embedded file name: /usr/lib/enigma2/python/Screens/InfoBarGenerics.py
...
class InfoBarTimeshift():
    ...
    def __init__(self):
        self['TimeshiftActions'] = HelpableActionMap(self, 'InfobarTimeshiftActions', {'timeshiftStart': (self.startTimeshift, _('Start timeshift')),
         ...
         'seekdef:9': (boundFunction(self.seekdef, 9), _('Seek'))}, prio=0)
...
class InfoBarExtensions():
    ...
    def videomanualesSF(self):
        from Plugins.Extensions.videomanualesSF.plugin import videomanualesSF
        self.session.open(videomanualesSF)
